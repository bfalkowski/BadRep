...
from core.evaluation import (
    MatchStrategy, FindingType, ReviewFinding, MatchResult,
    EvaluationMetrics, EvaluationResult, EvaluationEngine
)
...
class TestEvaluationEngine:
    ...
    def test_evaluate_review_empty_inputs(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with pytest.raises(EvaluationError, match="Both review findings and ground truth entries are required"):
