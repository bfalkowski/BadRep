...
from core.bug_injection import (
    BugInjectionEngine, GroundTruthLogger, GroundTruthEntry, 
    InjectionSession
)
from core.bug_templates import BugTemplate, BugCategory, BugSeverity, BugDifficulty
from core.plugins.base import InjectionResult, CodeModification, CodeLocation
...
class TestBugInjectionEngine:
    ...
    @patch('core.plugins.PluginManager')
    @patch('core.bug_templates.BugTemplateManager')
    def test_start_injection_session_unsupported_language(self, mock_template_manager, mock_plugin_manager):
    ...
    def test_get_available_templates(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            filtered_templates = engine.get_available_templates("java", category="correctness", difficulty="easy")
