...
class LanguageError(ReviewLabError):
    ...
    def __init__(self, message: str, language: str = None, details: Optional[Dict[str, Any]] = None):
        if language:
            details = details or {}
...
class InjectionError(ReviewLabError):
    ...
    def __init__(self, message: str, file_path: str = None, bug_type: str = None, details: Optional[Dict[str, Any]] = None):
