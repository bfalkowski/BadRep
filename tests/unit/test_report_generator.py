...
from core.evaluation import (
    EvaluationResult, EvaluationMetrics, ReviewFinding, 
    MatchResult, GroundTruthEntry, MatchStrategy, FindingType
)
...
class TestReportGenerator:
    ...
    def test_generate_performance_insights(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert "Higher recall than precision suggests the tool prioritizes coverage over accuracy" in insights
    ...
    def test_generate_recommendations(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert "Focus on reducing false positives by improving detection rules" in recommendations
